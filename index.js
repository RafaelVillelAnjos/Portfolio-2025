...
/* Generic modal manager (reusable) */
const ModalManager = (function(){
    let active = null; // { modal, handlers, timer }
    ...
    return {
        toggle(modalSelector, triggerElem){
            ...
            // If another modal is active, force-hide it immediately so modals never overlap
            if(active && active.modal !== modal){
                forceHideActive();
            }
...
// wrappers used by HTML onclicks
